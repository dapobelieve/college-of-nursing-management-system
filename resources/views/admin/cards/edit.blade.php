                            ...
                            <div class="widget-box">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="row">
                                        ...
                                        @endif
                                        <form method="post" action="{{route('cards.update', ['card' => $card->id])}}" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-md-6 col-lg-6">
                                                    <input value="{{ $card->serial_no }}" id="amount" name="hod" placeholder="Serial number" type="text" class="form-control input-sm" />
                                                </div>
                                            </div>
