...
@section('admin-content')
    ...
    <div id="content">
        ...
        <div id="breadcrumb">
            ...
            <a href="{{route('accounting.indexAdmission')}}" class="current">All Fees for Admission</a>
        </div>
        <div class="container-fluid">
          <div class="row">

             <div class="col-xs-12 col-sm-6">
               <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" title="Generate payment report of applicants">Generate Admission Report</button>
               ...
               <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                 <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form method="post" action="{{route('accounting.expADMFEES')}}" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="col-sm-12 col-xs-12 col-md-12">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="reg_no"  class="form-control form-control-lg" placeholder="Reg. No.">
                              </div>
            ...
            <div class="col-xs-12 col-md-12">
              ...
              <div id="justclear2">{{$pay_app->links()}}</div>
            </div>
          </div>
        </div>
      </div>
