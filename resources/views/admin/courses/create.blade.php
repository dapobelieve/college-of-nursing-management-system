                                    ...
                                    <div class="row">
                                        ...
                                        <form method="post" action="{{route('courses.store')}}" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-md-6 col-lg-6">
                                                    <input id="name" value="{{ old('title') }}" type="text" placeholder="Department Name" name="title" class="form-control input-sm" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="col-sm-3 col-md-3 col-lg-2 control-label">Course Code:</label>
                                                <div class="col-sm-9 col-md-6 col-lg-6">
                                                    <input id="name" value="{{ old('code') }}" type="text" placeholder="Code" name="code" class="form-control input-sm" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="col-sm-3 col-md-3 col-lg-2 control-label">Course Units:</label>
                                                <div class="col-sm-9 col-md-6 col-lg-6">
                                                    <input id="name" min="1" value="{{ old('units') }}" type="number" placeholder="Units" name="units" class="form-control input-sm" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-md-6 col-lg-6">
                                                    <input id="level" min="100" value="{{ old('level') }}" type="number" placeholder="Level" name="level" class="form-control input-sm" />
                                                </div>
                                            </div>
