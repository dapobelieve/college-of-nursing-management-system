                          ...
                          <tbody>
                            ...
                            <?php $no = $key +1; ?>
                              <tr>
                                ...
                                <td><a href="{{action('RegHistoryController@downloadPDF', [$student->id, $value->level." ".$value->semester, date("d-m-y",strtotime($value->created_at))])}}"><button type="button" class="btn btn-outline-info btn-sm">PRINT</button></a></td>
                              </tr>
                            @endforeach;
                          </tbody>
                        </table>
